...
public class AdapterHyd1 extends RecyclerView.Adapter<AdapterHyd1.AdapterInnerClass> {

    Context mContext;

    public AdapterHyd1(Context mContext){
    ...
    public AdapterInnerClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View myLayout = inflater.inflate(R.layout.recycler_hyd1, parent, false);
    ...
    public void onBindViewHolder(@NonNull AdapterInnerClass holder, final int position) {
        holder.imageView.setImageResource(HotelConstant.IMAGE_HYD_HOTEL1[position]);
        holder.textTitle.setText(HotelConstant.TITLE_HYD_HOTEL1[position]);
        holder.textDesc.setText(HotelConstant.PRICE_HYD_HOTEL1[position]);
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(mContext, RoomBookActivity.class);
                in.putExtra("rtype", HotelConstant.TITLE_HYD_HOTEL1[position]);
                in.putExtra("price", HotelConstant.PRICE_HYD_HOTEL1[position]);
    ...
    public int getItemCount() {
        return HotelConstant.PRICE_HYD_HOTEL1.length;
    }
