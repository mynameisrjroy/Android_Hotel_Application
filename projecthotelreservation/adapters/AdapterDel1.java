...
public class AdapterDel1 extends RecyclerView.Adapter<AdapterDel1.AdapterInnerClass> {

    Context mContext;

    public AdapterDel1(Context mContext){
    ...
    public AdapterInnerClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View myLayout = inflater.inflate(R.layout.recycler_del1, parent, false);
    ...
    public void onBindViewHolder(@NonNull AdapterInnerClass holder, final int position) {
        holder.imageView.setImageResource(HotelConstant.IMAGE_DEL_HOTEL1[position]);
        holder.textTitle.setText(HotelConstant.TITLE_DEL_HOTEL1[position]);
        holder.textDesc.setText(HotelConstant.PRICE_DEL_HOTEL1[position]);
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(mContext, RoomBookActivity.class);
                in.putExtra("rtype", HotelConstant.TITLE_DEL_HOTEL1[position]);
                in.putExtra("price", HotelConstant.PRICE_DEL_HOTEL1[position]);
    ...
    public int getItemCount() {
        return HotelConstant.PRICE_DEL_HOTEL1.length;
    }
