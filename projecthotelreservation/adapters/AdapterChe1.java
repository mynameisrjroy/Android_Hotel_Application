...
public class AdapterChe1 extends RecyclerView.Adapter<AdapterChe1.AdapterInnerClass> {

    Context mContext;

    public AdapterChe1(Context mContext){
    ...
    public AdapterInnerClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View myLayout = inflater.inflate(R.layout.recycler_che1, parent, false);
    ...
    public void onBindViewHolder(@NonNull AdapterInnerClass holder, final int position) {
        holder.imageView.setImageResource(HotelConstant.IMAGE_CHE_HOTEL1[position]);
        holder.textTitle.setText(HotelConstant.TITLE_CHE_HOTEL1[position]);
        holder.textDesc.setText(HotelConstant.PRICE_CHE_HOTEL1[position]);
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(mContext, RoomBookActivity.class);
                in.putExtra("rtype", HotelConstant.TITLE_CHE_HOTEL1[position]);
                in.putExtra("price", HotelConstant.PRICE_CHE_HOTEL1[position]);
    ...
    public int getItemCount() {
        return HotelConstant.PRICE_CHE_HOTEL1.length;
    }
