...
import com.example.projecthotelreservation.FoodActivity;
...
public class AdapterHyd4 extends RecyclerView.Adapter<AdapterHyd4.AdapterInnerClass> {

    Context mContext;

    public AdapterHyd4(Context mContext){
    ...
    public AdapterInnerClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View myLayout = inflater.inflate(R.layout.recycler_hyd4, parent, false);
    ...
    public void onBindViewHolder(@NonNull AdapterInnerClass holder, final int position) {
        holder.imageView.setImageResource(HotelConstant.IMAGE_HYD_HOTEL4[position]);
        holder.textTitle.setText(HotelConstant.TITLE_HYD_HOTEL4[position]);
        holder.textDesc.setText(HotelConstant.PRICE_HYD_HOTEL4[position]);
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(mContext, RoomBookActivity.class);
                in.putExtra("rtype", HotelConstant.TITLE_HYD_HOTEL4[position]);
                in.putExtra("price", HotelConstant.PRICE_HYD_HOTEL4[position]);
    ...
    public int getItemCount() {
        return HotelConstant.PRICE_HYD_HOTEL4.length;
    }
