...
public class AdapterKol2 extends RecyclerView.Adapter<AdapterKol2.AdapterInnerClass> {

    Context mContext;

    public AdapterKol2(Context mContext){
    ...
    public AdapterInnerClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View myLayout = inflater.inflate(R.layout.recycler_kol2, parent, false);
    ...
    public void onBindViewHolder(@NonNull AdapterInnerClass holder, final int position) {
        holder.imageView.setImageResource(HotelConstant.IMAGE_KOL_HOTEL2[position]);
        holder.textTitle.setText(HotelConstant.TITLE_KOL_HOTEL2[position]);
        holder.textDesc.setText(HotelConstant.PRICE_KOL_HOTEL2[position]);
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(mContext, RoomBookActivity.class);
                in.putExtra("rtype", HotelConstant.TITLE_KOL_HOTEL2[position]);
                in.putExtra("price", HotelConstant.PRICE_KOL_HOTEL2[position]);
    ...
    public int getItemCount() {
        return HotelConstant.PRICE_KOL_HOTEL2.length;
    }
