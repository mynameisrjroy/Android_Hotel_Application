...
public class AdapterKol3 extends RecyclerView.Adapter<AdapterKol3.AdapterInnerClass> {

    Context mContext;

    public AdapterKol3 (Context mContext){
    ...
    public void onBindViewHolder(@NonNull AdapterInnerClass holder, final int position) {
        holder.imageView.setImageResource(HotelConstant.IMAGE_KOL_HOTEL3[position]);
        holder.textTitle.setText(HotelConstant.TITLE_KOL_HOTEL3[position]);
        holder.textDesc.setText(HotelConstant.PRICE_KOL_HOTEL3[position]);
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(mContext, RoomBookActivity.class);
                in.putExtra("rtype", HotelConstant.TITLE_KOL_HOTEL3[position]);
                in.putExtra("price", HotelConstant.PRICE_KOL_HOTEL3[position]);
    ...
    public int getItemCount() {
        return HotelConstant.PRICE_KOL_HOTEL3.length;
    }
