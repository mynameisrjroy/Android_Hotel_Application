...
public class AdapterMum3 extends RecyclerView.Adapter<AdapterMum3.AdapterInnerClass> {

    Context mContext;

    public AdapterMum3(Context mContext){
    ...
    public AdapterInnerClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View myLayout = inflater.inflate(R.layout.recycler_mum3, parent, false);
    ...
    public void onBindViewHolder(@NonNull AdapterInnerClass holder, final int position) {
        holder.imageView.setImageResource(HotelConstant.IMAGE_MUM_HOTEL3[position]);
        holder.textTitle.setText(HotelConstant.TITLE_MUM_HOTEL3[position]);
        holder.textDesc.setText(HotelConstant.PRICE_MUM_HOTEL3[position]);
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(mContext, RoomBookActivity.class);
                in.putExtra("rtype", HotelConstant.TITLE_MUM_HOTEL3[position]);
                in.putExtra("price", HotelConstant.PRICE_MUM_HOTEL3[position]);
    ...
    public int getItemCount() {
        return HotelConstant.PRICE_MUM_HOTEL3.length;
    }
